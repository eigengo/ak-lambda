...
docker run eigrad/tcpkali --first-message 'device-1' --message "$MESSAGE" --message-rate 100 --connections 5 --duration 60 "$1" &
docker run eigrad/tcpkali --first-message 'device-2' --message "$MESSAGE" --message-rate 100 --connections 5 --duration 60 "$1" &
docker run eigrad/tcpkali --first-message 'device-3' --message "$MESSAGE" --message-rate 100 --connections 5 --duration 60 "$1"
