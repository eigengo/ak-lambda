...
docker run eigrad/tcpkali --first-message 'device-1' --message "$MESSAGE" --message-rate 10 --connections 1 "$1" &
docker run eigrad/tcpkali --first-message 'device-2' --message "$MESSAGE" --message-rate 10 --connections 1 "$1"
